...
class BranchTransfersScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (_) => TableColumnVisibilityProvider('branch_transfer'),
      child: SafeArea(
        child: Column(
            children: [
  ...
  Widget _transferTable(BuildContext context, List<BranchTransferRecord> transfers) {
    ...
    // Convert BranchTransferRecord objects to Map<String, dynamic>
                      ...
                      onPressed: () {
                        Navigator.of(context).push(
                          AnimatedRoutes.slideRight(
                            const CreateBranchTransferScreen(),
                          ),
                        );
                      },
                  ...
                  children: [
                                  ...
                                  return AlertDialog(
                                    ...
                                    content: SizedBox(
                                      ...
                                      child: _InlineColumnPicker(
                                        ...
                                        title: 'Manage Branch Transfer Columns',
                                      ),
                                    ),
                                  );
                                },
                    ...
                    SizedBox(
                      ...
                      child: SchemaTable<Map<String, dynamic>>(
                        ...
                        emptyLabel: 'No branch transfers found.',
  ...
  // Mobile card view for Branch Transfers
  Widget _buildMobileCardView(List<BranchTransferRecord> transfers) {
    if (transfers.isEmpty) {
      return Container(
        ...
        child: const Center(
          child: Text('No branch transfers found.'),
        ),
      );
    }
  ...
  Color _getStatusColor(String status) {
    ...
    if (lower.contains('completed') || lower.contains('delivered')) {
      return Colors.green;
