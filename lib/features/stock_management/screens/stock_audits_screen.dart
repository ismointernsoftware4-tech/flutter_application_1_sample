...
class StockAuditsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (_) => TableColumnVisibilityProvider('stock_audit'),
      child: SafeArea(
        child: Column(
            children: [
  ...
  Widget _auditTable(BuildContext context, List<StockAuditRecord> audits) {
    ...
    if (isMobile) {
      return _buildMobileCardView(audits);
    }
    
    // Convert StockAuditRecord objects to Map<String, dynamic>
    final mappedData = audits
        .map<Map<String, dynamic>>(
          (audit) => {
            ...
            'status': audit.status,
            'discrepancies': audit.discrepancies.toString(),
          },
        )
        .toList();
                  ...
                  children: [
                                  ...
                                  return AlertDialog(
                                    ...
                                    content: SizedBox(
                                      ...
                                      child: _InlineColumnPicker(
                                        ...
                                        title: 'Manage Stock Audit Columns',
                                      ),
                                    ),
                                  );
                                },
                    ...
                    SizedBox(
                      ...
                      child: SchemaTable<Map<String, dynamic>>(
                        ...
                        emptyLabel: 'No stock audits found.',
  ...
  // Mobile card view for Stock Audits
  Widget _buildMobileCardView(List<StockAuditRecord> audits) {
    if (audits.isEmpty) {
      return Container(
        ...
        child: const Center(
          child: Text('No stock audits found.'),
        ),
      );
    }
            ...
            child: Column(
              ...
              children: [
                ...
                Wrap(
                  ...
                  runSpacing: 8,
                  children: [
                    _buildMobileInfoRow('Date', audit.date),
                    _buildMobileInfoRow('Auditor', audit.auditor),
                    _buildMobileInfoRow('Discrepancies', audit.discrepancies.toString()),
                  ],
                ),
                const SizedBox(height: 12),
                Row(
  ...
  Color _getStatusColor(String status) {
    ...
    if (lower.contains('completed') || lower.contains('approved')) {
      return Colors.green;
    } else if (lower.contains('pending') || lower.contains('in progress')) {
