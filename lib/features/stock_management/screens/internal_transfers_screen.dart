...
class InternalTransfersScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (_) => TableColumnVisibilityProvider('internal_transfer'),
      child: SafeArea(
        child: Column(
            children: [
  ...
  Widget _transferTable(BuildContext context, List<StockTransferRecord> transfers) {
    ...
    if (isMobile) {
      return _buildMobileCardView(transfers);
    }
    
    // Convert StockTransferRecord objects to Map<String, dynamic>
    final mappedData = transfers
                ...
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Manage stock movements between internal locations.',
                          style: TextStyle(
                  ...
                  Flexible(
                    child: ElevatedButton.icon(
                      ...
                      label: Text(
                        isMobile ? 'New Transfer' : 'New Transfer',
                      ),
                  ...
                  children: [
                                  ...
                                  return AlertDialog(
                                    ...
                                    content: SizedBox(
                                      ...
                                      child: _InlineColumnPicker(
                                        ...
                                        title: 'Manage Internal Transfer Columns',
                                      ),
                                    ),
                                  );
                                },
                    ...
                    SizedBox(
                      ...
                      child: SchemaTable<Map<String, dynamic>>(
                        ...
                        emptyLabel: 'No internal transfers found.',
  ...
  // Mobile card view for Internal Transfers
  Widget _buildMobileCardView(List<StockTransferRecord> transfers) {
    if (transfers.isEmpty) {
      return Container(
        ...
        child: const Center(
          child: Text('No internal transfers found.'),
        ),
      );
    }
            ...
            child: Column(
              ...
              children: [
                ...
                Wrap(
                  ...
                  runSpacing: 8,
                  children: [
                    _buildMobileInfoRow('Date', transfer.date),
                    _buildMobileInfoRow('Quantity', transfer.quantity.toString()),
                  ],
                ),
                const SizedBox(height: 12),
                Row(
  ...
  Color _getStatusColor(String status) {
    ...
    if (lower.contains('completed') || lower.contains('approved')) {
      return Colors.green;
    } else if (lower.contains('pending') || lower.contains('in transit')) {
